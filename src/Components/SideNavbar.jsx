...
import profile from '../../assets/images/profilec.png'
...
<div className='border-t flex p-3'>
  ...
  <div className={`flex justify-between items-center overflow-hidden transition-all  ${expanded?"w-32  ml-1":"w-0"}`}>
    <div className='leading-4'>
          <h4 className='font-semibold'>Bhipra</h4>
          <span className='text-xs to-gray-600'>bhipragps@gmail.com</span>
    </div>
